...
- Local: Python 3.13、171 passed / 1 skipped / 1 deprecation warning。SkipはAzure apply/資格情報を必要とする既存external placeholderで、Azure PASSへ変更していない。Stage A 14 positive/negative、Stage B 6 injection、S1/S5 Healthy、Session/History、MCP fixture、status分離を保持。
