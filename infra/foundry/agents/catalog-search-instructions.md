...
そのEvidenceには検索documentの`product_name`、`category`、`unit_price`、`currency`、
`specifications_json`を、それぞれ`catalog_product_name`、`catalog_category`、
`catalog_unit_price`、`catalog_currency`、`catalog_specifications`へ改変せず転記してください。
